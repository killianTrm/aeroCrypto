...
var key = array[0]
var refPiece = array[1]
var nomPiece = array[2]
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    // recordPiece - requires 5 args, ID, vessel, location, timestamp,holder - ex: args: ['10', 'Hound', '-12.021, 28.012', '1504054225', 'Hansel'], 
    // send proposal to endorser
    const request = {
        //targets : --- letting this default to the peers assigned to the channel
        chaincodeId: 'tuna-app',
        fcn: 'recordPiece',
        args: [key, refPiece, nomPiece, nomFabricant, numeroLot, dateExp, localisationVille, localisationEtablissement, dateCreation, dateReception, venteClient],
        chainId: 'mychannel',
        txId: tx_id
    };
