...
return{
	get_all_piece: function(req, res){
		console.log("getting all piece from database: ");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // queryAllpiece - requires no arguments , ex: args: [''],
		    const request = {
	...
	add_piece: function(req, res){
		console.log("submit recording of piece");

		var array = req.params.piece.split("-");
		console.log(array);
